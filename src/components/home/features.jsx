  ...
  return (
    <div class="max-w-7xl max-md:max-w-xl mx-auto font-[sans-serif] my-4">
      <div class="text-center max-w-2xl mx-auto">
        <h2 class="dark:text-gray-50 text-gray-800 text-4xl font-extrabold text-center mb-6">
          Funciones Exclusivas
        </h2>
        <p class="dark:text-gray-50 text-gray-600 text-base">
      ...
      <div class="mt-6">
        <div class="grid md:grid-cols-2 items-center gap-8">
          ...
          <div>
            <h3 class="text-primary text-2xl font-bold mb-4">
